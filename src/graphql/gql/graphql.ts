...
export type GetUserResultsQuery = { __typename?: 'Query', listUserResults: Array<{ __typename?: 'ListUserResultsOutput', id: string, quizTitle: string, points: number, total: number }> };
